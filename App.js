...
class App extends PureComponent {
    ...
    render() {
        return (
            ...
            <View style={styles.container}>
                ...
                {
                    this.state.isPhotoWeb ?
                        <View>
                            <Image source={{ uri: this.state.dataWeb[0].urls.raw }}
    ...
    getImage() {
        ...
        fetch("https://api.unsplash.com/photos/random?count=1&client_id=A0IP0wQqmhXik-rJOtlrBNJ4trCwqbswA6mvQ79674U", requestOptions)
